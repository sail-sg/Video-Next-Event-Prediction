...
class RLHFDataset(Dataset):
        ...
        if "{" in data_path and "}" in data_path:
            ...
            with open(data_path, "r") as file:
                ...
                for dataset in datasets:
                    ...
                    print("\033[31m" + f"Loading {json_path} with {sampling_strategy} sampling strategy" + "\033[0m")
    ...
    def __getitem__(self, index):
        ...
        row_dict = dict()
        video_file = data_item['video_path'].split('/', 1)[-1]
        video_path = os.path.join('~/NextEventPrediction/V1-33K/first_part_video', video_file)

        question = data_item['qa']["Question"]
        options = data_item['qa']["Options"]
        answer = data_item['qa']["Answer"]
        ...
        # NOTE: we don't need video length for v1 reward
        ...
        row_dict["ground_truth"] = data_item['qa']["Answer"]
        return row_dict
